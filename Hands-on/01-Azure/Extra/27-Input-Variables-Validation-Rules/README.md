...
substr("hashicorp terraform", 1, 4)
substr("hashicorp terraform", 0, 6)
substr("hashicorp terraform", 0, 1)
substr("hashicorp terraform", 0, 0)
substr("hashicorp terraform", 0, 10)
```
...
# Roll back to state as below for  seamless demo before git check-in
