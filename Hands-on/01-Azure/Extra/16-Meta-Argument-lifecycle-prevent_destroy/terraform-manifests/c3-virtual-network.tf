...
/* Sample Error
AtinG-MacBook-Pro:v7-terraform-manifests-lifecycle-prevent_destroy agupta$ terraform apply -auto-approve
...
╵
AtinG-MacBook-Pro:v7-terraform-manifests-lifecycle-prevent_destroy agupta$ 
*/