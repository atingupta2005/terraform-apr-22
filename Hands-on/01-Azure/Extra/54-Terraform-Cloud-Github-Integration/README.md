...
git clone https://github.com/atingupta2005/terraform-cloud-azure-demo1.git
```
...
https://github.com/atingupta2005/terraform-cloud-azure-demo1.git
```
...
- **Email Address:** hashicorpterraform@gmail.com
...
- **Connect to VCS**
  ...
  - **Selected 1 Repository:** atingupta2005/terraform-cloud-azure-demo1
  - Click on **Install**
- **Choose a Repository**
  - atingupta2005/terraform-cloud-azure-demo1
- **Configure Settings**
...
# Verify Terraform Cloud
Go to Workspace -> Runs
Message: Workspace locked by user atingupta2005. It must be unlocked before Terraform can execute.
...
- Comment both tags (Tag1, Tag2) in c3-locals.tf for  seamless demo
```t
  common_tags = {
